    ...
    <div className='flex justify-around text-white bg-[#737373] rounded-t-xl py-5 mt-32'>
      ...
      <div>
        ...
        <div className='flex space-x-3 mt-3'>
          <img src='/facebook.png' alt='' className='w-10 h-w-10 object-cover'/>
          <img src='/whatsapp.png' alt='' className='w-10 h-w-10 object-cover'/>
        </div>
      </div>
      <div>
        <div className="text-center font-bold">Follow Us</div>
        <div className='flex space-x-3 mt-3'>
          <img src='/twitter.png' alt='' className='w-10 h-w-10 object-cover'/>
          <img src='/facebook.png' alt='' className='w-10 h-w-10 object-cover'/>
          <img src='/instagram.png' alt='' className='w-10 h-w-10 object-cover'/>
        </div>
      </div>
    </div>
  )
